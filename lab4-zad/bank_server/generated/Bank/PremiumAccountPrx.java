...
{
    default CreditCost requestLoan(Money ammount, LoanPeriod period)
    {
        return requestLoan(ammount, period, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default CreditCost requestLoan(Money ammount, LoanPeriod period, java.util.Map<String, String> context)
    {
        return _iceI_requestLoanAsync(ammount, period, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<CreditCost> requestLoanAsync(Money ammount, LoanPeriod period)
    {
        return _iceI_requestLoanAsync(ammount, period, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<CreditCost> requestLoanAsync(Money ammount, LoanPeriod period, java.util.Map<String, String> context)
    {
        return _iceI_requestLoanAsync(ammount, period, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<CreditCost> _iceI_requestLoanAsync(Money iceP_ammount, LoanPeriod iceP_period, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<CreditCost> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "requestLoan", null, sync, null);
        f.invoke(true, context, null, ostr -> {
                     Money.ice_write(ostr, iceP_ammount);
                     LoanPeriod.ice_write(ostr, iceP_period);
                 }, istr -> {
                     CreditCost ret;
                     ret = CreditCost.ice_read(istr);
                     return ret;
                 });
        return f;
    }
